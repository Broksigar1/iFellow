...
import ru.IFellow.carBrands.BMW;
import ru.IFellow.carBrands.Ford;
import ru.IFellow.carBrands.Opel;
import ru.IFellow.carBrands.Suzuki;
import ru.IFellow.carBrands.Toyota;
...
public class Main
{
    public static void main(String[] args)
    {
        ...
        CarHandler.getInfoAboutCarsWhichWasManufacturedAfterSpecifiedYear(cars, 2006);
        System.out.println(DELIMITER);

        for (Car car : cars)
        {
            System.out.println("Color before - " + CarHandler.getColorName(car.getColor()));
            CarHandler.repaintCarIfItGreen(car, Color.RED);
